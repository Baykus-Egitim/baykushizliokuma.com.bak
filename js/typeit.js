        ...
        var b = function () {
            ...
            return e = t, (n = [{
                ...
                key: "reset", value: function () {
                    return this.waiting = g(this.executed).concat(g(this.waiting)), this.executed = [], this
                }
        ...
        var k = "display:inline;position:relative;font:inherit;color:inherit;line-height:inherit;", q = function () {
            ...
            return e = t, (n = [{
                ...
                key: "handleHardCoded", value: function (t) {
                    return !!t.length && (this.opts.startDelete ? (this.insert(t), this.queue.add([this.delete, !0]), void this.addSplitPause(1)) : void(this.opts.strings = w(l(t.trim())).concat(w(this.opts.strings))))
                }
            }, {

...
<head>
<base href="/bho.dursunkarabatak.com" />
    ...
    <section id="faq" class="section-padding">
      <div class="container">
        <div class="section-header text-center">
          <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">Kullanımı ve Hizmet Şartları</h2>
...
<?php 
$id = $_GET["id"];
$query=mysql_query("SELECT * FROM blog Where id='$id'"); while ($data = mysql_fetch_array($query)) { ?>		  
          <h2 class="section-title wow fadeInDown animated" data-wow-delay="0.3s" style="visibility: visible;-webkit-animation-delay: 0.3s; -moz-animation-delay: 0.3s; animation-delay: 0.3s;"><?=$data['baslik']?></h2>
		...
		<center><img style="width: 100%; height: auto; padding-bottom: 30px;" src="blog/<?=$data['resim']?>" /></center>
            <center><p class="wow fadeIn" data-wow-delay="0.3s"><?=$data['icerik']?></p></center>
        ...
        <footer id="footer" class="">
            <div class="row">
                <div class="col-md-6 contact-col-1">
                    <div class="iletisimform">
                        ...
                        <form role="form" action="/tr/iletisim/" method="post">
                            ...
                            </div><button style="background-color: #8f3e9f;" type="submit" class="btn btn-gonder2 btn-lg" name="gonder">GÖNDER</button></form>
                    </div>
                </div>
                ...
                <div class="col-md-6 iletisimbilgi iletisimmobil">
                    ...
                    <div class="col-md-4">
                        <p style="color: #f3f6f6; margin-left: -14px;">0 (850) 346 90 28 0505 832 19 13</p>
                    </div>
                    <div class="col-md-6">
                        <p style="color:#fff; padding-top: 30px; margin-left: -14px;"><b>Mail Adresimiz</b></p>
                    </div>
                    <div class="col-md-3">
                        <p style="color: #f3f6f6; margin-left: -14px;">bilgi@baykushizliokuma.com satis@baykushizliokuma.com
                        </p>
                    </div>
                </div>
            </div>

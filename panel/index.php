            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              <?php $query=mysql_query("SELECT * FROM anasayfa_".$lang.""); while ($data = mysql_fetch_array($query)) { $i++; ?>
                                <form method="POST" action="includes/functions.php?anasayfa-guncelle" enctype="multipart/form-data">
                                  ...
                                  <div class="modal-body">
									...
									<div class="form-group 6">
                                      <label for="recipient-name" class="control-label">Alt Başlık:</label>
                                      <div class="controls">
                                        <input name="altbaslik" placeholder="Alt Başlık" type="text" class="form-control" value="<?php echo $data['altbaslik']; ?>">
                                      </div>
                                    </div>
